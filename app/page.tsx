  ...
  return (
    <div className="min-h-screen flex flex-col bg-zinc-950 relative overflow-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between p-6 max-w-7xl mx-auto w-full">
        ...
        <Link href="/dashboard">
          <button className="px-6 py-2.5 rounded-full bg-white/5 border border-white/10 text-white text-sm font-bold tracking-widest uppercase hover:bg-white/10 transition-colors backdrop-blur-md">
            Enter App
          </button>
        </Link>
      </nav>
      ...
      <main className="flex-1 flex flex-col items-center justify-center relative z-10 px-6 text-center">
        ...
        <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-white uppercase mb-6 drop-shadow-2xl max-w-5xl leading-[0.9]">
          The Ultimate <br/>
        ...
        <p className="text-zinc-400 max-w-2xl text-lg font-mono tracking-wide mb-12">
        ...
        <Link href="/dashboard">
          <button className="group relative px-8 py-4 bg-emerald-500 rounded-lg font-black uppercase tracking-[0.2em] text-emerald-950 transition-all hover:bg-emerald-400 hover:shadow-[0_0_40px_rgba(16,185,129,0.4)] flex items-center space-x-3">
      ...
      <div className="relative z-10 border-t border-white/5 bg-black/40 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-3 gap-8 p-12">
